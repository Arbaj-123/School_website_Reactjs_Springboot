...
const Studentnew = () => {
  // const navigation_link = useParams();
  // alert(navigation_link);
  ...
  const addStudentData = (event) => {
    ...
    axios
      .post("http://localhost:8080/stud_reg", initVal)
      .then((res) => {
    ...
    // console.log("Hello This is images", photo.name);
    setInitVal({
      stu_fname: "",
      stu_mname: "",
      stu_lname: "",
        ...
        <div>
          ...
          <div className="mb-3">
            ...
            >
              ...
              {newClass.map((value, ind) => {
                return (
                  <>
                    <option value={value.cls_name}>{value.cls_name}</option>
                  </>
                );
              })}
            </select>
          ...
          <div className="mb-3">
            ...
            >
              ...
              {newBatch.map((value, ind) => {
                return (
                  <>
                    <option value={value.batch_name}>{value.batch_name}</option>
                  </>
                );
              })}
            </select>
