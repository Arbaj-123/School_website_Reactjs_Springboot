    ...
    <div className="quixnav">
      <div className="quixnav-scroll">
        <ul className="metismenu" id="menu">
          ...
          <li>
            <NavLink className="" to="/dashboard" aria-expanded="false">
            ...
            {/* <ul aria-expanded="false">
              ...
              <li>
                <NavLink to="/">Dashboard 2</NavLink>
              </li>
            </ul> */}
          </li>
          {/* <li className="nav-label">Main Navigation</li> */}
          <li>
          ...
          <li>
            ...
            <ul aria-expanded="false">
              ...
              <li>
                <NavLink to="/teacherTable">Teacher Info</NavLink>
              </li>
              {/* <li>
          ...
          <li>
            ...
            <ul aria-expanded="false">
              <li>
                <NavLink to="/homeworkTable">Homework</NavLink>
              </li>
              <li>
